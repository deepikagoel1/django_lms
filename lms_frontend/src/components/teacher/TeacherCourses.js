                    ...
                    <div className='card-body'>
                        <table  className='table table-striped table-hover table-bordered border-primary table-default'>
                            ...
                            <tbody>
                                ...
                                <td>
                                    <Link className='btn btn-info btn-sm ms-2 mt-2' to ={"/edit-course/" + course.id}>Edit Course</Link>
                                    <Link className='btn btn-success btn-sm ms-2 mt-2' to ={"/add-chapter/" + course.id}>Add Chapter</Link>
                                    <Link className='btn btn-warning btn-sm ms-2 mt-2' to ={"/teacher-assign-quiz/" + course.id}>Assign Quiz</Link>
                                    <button type="button" className='btn btn-danger btn-sm ms-2 mt-2'>Delete</button>
                                </td>
                                </tr>
                                )}
                            </tbody>
